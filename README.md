...
## Substrate vs. app (CortenForge)
We have a reusable substrate (CortenForge) made of `sim_core`, `vision_core`/`vision_runtime`, `data_contracts`, `models`, `training`, `inference`, `capture_utils`, and `colon_sim_tools`. Apps build on it:
