...
- Docs:
  - Contributor book (architecture/extension points): https://via-balaena.github.io/CortenForge/contributor/
  - Crate dissection book (deep dives per crate + flows): https://via-balaena.github.io/CortenForge/dissection/
  - The old user book has been retired; user-facing flows now live in app-specific repos.
...
## Contributing
See `docs/contributor_book` for architecture, extension points, and testing notes. The crate dissection book is at `docs/dissection_book` for per-crate deep dives. App contributions now belong in the app repositories.
