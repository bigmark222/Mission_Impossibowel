...
- Tag points at the expected commit: `git show v0.2.0 --no-patch`
- Tag is on origin: `git ls-remote --tags origin v0.2.0`
- Crates.io shows 0.2.0: `https://crates.io/crates/<crate>`
