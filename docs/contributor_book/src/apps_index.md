...
- Burn uses the fixed `burn-core 0.14.1` release; no vendored patch required.
...
- Keep the lockfile fresh before release; `burn-core 0.14.1` avoids the prior publish break.
