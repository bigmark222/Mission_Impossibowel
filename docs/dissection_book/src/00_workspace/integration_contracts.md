...
| Tooling features | `colon_sim_tools` bins: `tui`, `scheduler`, `gpu_nvidia` gate heavy deps; default footprint is minimal. |
...
| `colon_sim_tools` unpublished | App-specific bins belong in app repos; shared helpers may migrate. |
