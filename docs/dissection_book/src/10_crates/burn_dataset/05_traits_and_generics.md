...
- `WarehouseShardStore` (feature `burn_runtime`): trait abstraction for providing shard iterators. Methods: `train_iter`, `val_iter`, `train_len`, `val_len`, `total_shards`, `mode`.
